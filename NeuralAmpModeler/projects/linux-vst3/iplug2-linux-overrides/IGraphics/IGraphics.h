...
private:
  ...
  /** Called before the platform window is resized to match a host-driven resize
   * @param physW/physH \todo the physical size the host is requesting */
  virtual void OnBeginHostResize(int physW, int physH) {}

  /** Called after a host-driven resize completes */
